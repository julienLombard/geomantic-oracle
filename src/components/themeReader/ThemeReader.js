      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td>
              {data[figures.niece2.name] && data[figures.niece2.name].maison_3}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {data[figures.niece3.name] && data[figures.niece3.name].maison_6}
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td>
              {data[figures.niece4.name] && data[figures.niece4.name].maison_9}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {data[figures.niece1.name] && data[figures.niece1.name].maison_12}
            </td>
          </tr>
        </tbody>
      </table>
